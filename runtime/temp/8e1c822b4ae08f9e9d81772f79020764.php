<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\phpStudy\WWW\CRM\public/../app/admin\view\ziyuan\zhengshu.html";i:1544691245;s:44:"D:\phpStudy\WWW\CRM\app\admin\view\nav3.html";i:1545450599;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<style type="text/css">
    ...
    if($authorid=='3'){
     ...
     ?>
        ...
        <form name="listform" method="post" action="/admin/ziyuan/zhengshu/nav3/2">
			<div class="selectionTop">
				<ul>
		...
		<div class="popUpsCont">
			<div class="proposal">
				...
				<div class="proposalBtn1">
                    <input name="zytype" type="hidden" value="zhengshu">
