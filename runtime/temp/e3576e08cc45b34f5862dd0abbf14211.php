<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\phpStudy\WWW\CRM\public/../app/admin\view\xiangmu\zhengshu.html";i:1545449193;s:44:"D:\phpStudy\WWW\CRM\app\admin\view\nav2.html";i:1544520280;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<title>CRM主界面-管理员-证书</title>
	</head>
     ...
     ?>
			...
			<div class="selectionCont">
				...
				<div class="itmeA">
                    ...
                    <input type="hidden" name="class" id="class1" value="zhengshu">
				</div>
                </form>
				...
				<div class="itmeB">
                    ...
                    <input type="hidden" name="class" id="class2" value="zhengshu">
				</div>
                </form>
				...
				<div class="itmeC">
                    ...
                    <input type="hidden" name="class" id="class3" value="zhengshu">
				</div>
                </form>
			</div>
	</body>
