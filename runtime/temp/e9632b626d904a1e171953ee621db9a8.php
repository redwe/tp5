<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\phpStudy\WWW\CRM\public/../app/admin\view\login\index.html";i:1544594305;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
...
<div style="width: 560px; padding: 30px; margin: auto; margin-top: 200px; background-color:#336699; border: #113366 1px solid">
    <h1 style="color: #fff; text-align: center">管理员后台登录</h1>
    <form name="loginform" action="/admin/login/dologin" method="post">
